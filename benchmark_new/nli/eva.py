...
PROMPTS_INPUTS = [
   "/your_path/benchmark2/dataset/test_5p.csv",
   "/your_path/benchmark2/dataset/test_6p.csv",
   "/your_path/benchmark2/dataset/test_7p.csv",
   "/your_path/benchmark2/dataset/test_8p.csv",
   "/your_path/benchmark2/dataset/test_9p.csv",
   "/your_path/benchmark2/dataset/test_10p.csv",
   "/your_path/benchmark2/dataset/test_gt10p.csv",
]
...
ANSWERS_INPUTS = [
    ...
    f"/your_path/Overton-PPO/workflow/{LLM_MODEL_NAME}/{MODE}/test_5p_gen.csv",
    f"/your_path/Overton-PPO/workflow/{LLM_MODEL_NAME}/{MODE}/test_6p_gen.csv",
    f"/your_path/Overton-PPO/workflow/{LLM_MODEL_NAME}/{MODE}/test_7p_gen.csv",
    f"/your_path/Overton-PPO/workflow/{LLM_MODEL_NAME}/{MODE}/test_8p_gen.csv",
    f"/your_path/Overton-PPO/workflow/{LLM_MODEL_NAME}/{MODE}/test_9p_gen.csv",
    f"/your_path/Overton-PPO/workflow/{LLM_MODEL_NAME}/{MODE}/test_10p_gen.csv",
    f"/your_path/Overton-PPO/workflow/{LLM_MODEL_NAME}/{MODE}/test_gt10p_gen.csv",

]

# Column names
PROMPT_TEXT_COL  = "prompt"   
STRUCTURED_COL   = "answer"   
ANSWERS_TEXT_COL = "answers" 
